...
<!-- header section ends -->
<!-- 
<div class="heading" style="background-image: linear-gradient(#333,white,#333);">
...
<div class="card bg-dark text-white">
  <img src="images/ordering2.gif" class="card-img" alt="...">
</div>
...
<section class="orders">
   ...
   <?php
         ...
         echo '<p class="empty">You didn\'t place any order yet!</p>';
      }
      }
   ?>
