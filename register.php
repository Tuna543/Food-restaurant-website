   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         if($select_user->rowCount() > 0){
            ...
            $message[] = 'registratioin successful!';
         }
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" required placeholder="enter your email" class="box" maxlength="50" style="text-transform: lowercase;" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <p style="margin-top: 10rem;">already have an account? <a href="login.php">login now</a></p>
   </form>
